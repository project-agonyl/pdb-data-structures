...
enum std::_Tree<unsigned long,std::pair<unsigned long const ,CPC *>,std::map<unsigned long,CPC *,std::less<unsigned long>,std::allocator<CPC *> >::_Kfn,std::less<unsigned long>,std::allocator<CPC *> >::_Redbl
{
    _Red=0,
    _Black=1
};
...
typedef struct _PC_2STAT_ // Size=24
{
    ...
    unsigned char byHitAddition; // Size=1 Offset=22
    unsigned char byMagAddition; // Size=1 Offset=23
} PC_2STAT_, *PPC_2STAT_;
typedef struct _ROOM_OPT_ // Size=4
{
    unsigned long battle_type: 1; // Size=4 Offset=0 BitOffset=0 BitCount=1
    unsigned long watch_allowed: 1; // Size=4 Offset=0 BitOffset=1 BitCount=1
    unsigned long time_out: 3; // Size=4 Offset=0 BitOffset=2 BitCount=3
    unsigned long team_distribute: 1; // Size=4 Offset=0 BitOffset=5 BitCount=1
    unsigned long team_count: 3; // Size=4 Offset=0 BitOffset=6 BitCount=3
    unsigned long allowed_pc_cnt: 6; // Size=4 Offset=0 BitOffset=9 BitCount=6
    unsigned long level_restrict: 3; // Size=4 Offset=0 BitOffset=15 BitCount=3
    unsigned long is_private: 1; // Size=4 Offset=0 BitOffset=18 BitCount=1
    unsigned long reserved: 13; // Size=4 Offset=0 BitOffset=19 BitCount=13
} ROOM_OPT_, *PROOM_OPT_;
...
typedef class MSG_S2C_NPC_ATTACK // Size=38
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwNPCID; // Size=4 Offset=12
...
typedef class MSG_S2C_UPDATE_PCEXP // Size=16
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
...
typedef struct _GAME_OPTION_ // Size=1
{
    ...
    unsigned char bReserved: 4; // Size=1 Offset=0 BitOffset=4 BitCount=4
...
typedef class MSG_S2M_CHAR_LOGIN // Size=41
{
    class MSG_S2S_HEADER MsgHeader; // Size=2 Offset=0
    char szPCName[13]; // Size=13 Offset=2
    char szAccountName[21]; // Size=21 Offset=15
...
typedef class MSG_C2B_ASK_WARP_Z2B // Size=12
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
} *PMSG_C2B_ASK_WARP_Z2B;
...
typedef struct _BATTLE_WARP_DATA_ // Size=8
{
    ...
    unsigned long dwOPCID; // Size=4 Offset=4
} BATTLE_WARP_DATA_, *PBATTLE_WARP_DATA_;
typedef class MSG_C2B_ASK_WARP_B2Z // Size=12
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
} *PMSG_C2B_ASK_WARP_B2Z;
...
typedef class MSG_B2C_ANS_WARP_B2Z // Size=15
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned short wPreMapIndex; // Size=2 Offset=12
    unsigned char byResult; // Size=1 Offset=14
} *PMSG_B2C_ANS_WARP_B2Z;
typedef class MSG_B2C_ANS_CREATE_ROOM // Size=17
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned char byResult; // Size=1 Offset=12
    unsigned long dwRoomID; // Size=4 Offset=13
} *PMSG_B2C_ANS_CREATE_ROOM;
typedef class MSG_C2B_ASK_ENTER_ROOM // Size=89
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwRoomID; // Size=4 Offset=12
    char szRoomName[64]; // Size=64 Offset=16
    char szPassWord[8]; // Size=8 Offset=80
    unsigned char byEnterType; // Size=1 Offset=88
} *PMSG_C2B_ASK_ENTER_ROOM;
typedef class MSG_B2C_ANS_ENTER_ROOM // Size=13
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned char byResult; // Size=1 Offset=12
} *PMSG_B2C_ANS_ENTER_ROOM;
typedef class MSG_B2C_SEE_ENTER_ROOM // Size=65
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwPCID; // Size=4 Offset=12
    char szName[13]; // Size=13 Offset=16
    char szClanName[32]; // Size=32 Offset=29
    int iTeam; // Size=4 Offset=61
} *PMSG_B2C_SEE_ENTER_ROOM;
typedef class MSG_C2B_ASK_LOBBY_INFO // Size=21
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwSearchStartRoomID; // Size=4 Offset=12
    int iSearchStartIndex; // Size=4 Offset=16
    unsigned char byFilter; // Size=1 Offset=20
} *PMSG_C2B_ASK_LOBBY_INFO;
typedef struct _WROOM_PC_DATA_ // Size=54
{
    int iTeam; // Size=4 Offset=0
    unsigned long dwPCID; // Size=4 Offset=4
    char szName[13]; // Size=13 Offset=8
    char szCLNName[32]; // Size=32 Offset=21
    unsigned char byStatus; // Size=1 Offset=53
} WROOM_PC_DATA_, *PWROOM_PC_DATA_;
typedef class MSG_C2B_ASK_CHANGE_TEAM // Size=17
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwRoomID; // Size=4 Offset=12
    unsigned char byExpectTeamNum; // Size=1 Offset=16
} *PMSG_C2B_ASK_CHANGE_TEAM;
typedef class MSG_B2C_ANS_CHANGE_TEAM // Size=14
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned char byResult; // Size=1 Offset=12
    unsigned char byChangedTeam; // Size=1 Offset=13
} *PMSG_B2C_ANS_CHANGE_TEAM;
typedef class MSG_B2C_SEE_CHANGE_TEAM // Size=24
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwChangePCID; // Size=4 Offset=12
    int iFromTeamIndex; // Size=4 Offset=16
    int iToTeamIndex; // Size=4 Offset=20
} *PMSG_B2C_SEE_CHANGE_TEAM;
typedef class MSG_C2B_READYOK_BATTLE // Size=13
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned char byReadyFlag; // Size=1 Offset=12
} *PMSG_C2B_READYOK_BATTLE;
typedef class MSG_B2C_SEE_READYOK_BATTLE // Size=17
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwReadyPCID; // Size=4 Offset=12
    unsigned char byReadyFlag; // Size=1 Offset=16
} *PMSG_B2C_SEE_READYOK_BATTLE;
typedef class MSG_C2B_ASK_START_BATTLE // Size=12
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
} *PMSG_C2B_ASK_START_BATTLE;
typedef class MSG_B2C_ANS_START_BATTLE // Size=13
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned char byResult; // Size=1 Offset=12
} *PMSG_B2C_ANS_START_BATTLE;
typedef class MSG_B2C_START_BATTLE // Size=13
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned char byMapIndex; // Size=1 Offset=12
} *PMSG_B2C_START_BATTLE;
typedef class MSG_C2B_MAPLOAD_OK // Size=12
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
} *PMSG_C2B_MAPLOAD_OK;
typedef class MSG_B2C_YOURCELL_IS_THIS // Size=16
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwCellIndex; // Size=4 Offset=12
} *PMSG_B2C_YOURCELL_IS_THIS;
typedef class MSG_B2C_ALL_ENTERED // Size=12
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
} *PMSG_B2C_ALL_ENTERED;
typedef class MSG_B2C_CHANGE_BOSS // Size=16
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwNewBossID; // Size=4 Offset=12
} *PMSG_B2C_CHANGE_BOSS;
typedef class MSG_C2B_ASK_COMEOUT_WROOM // Size=12
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
} *PMSG_C2B_ASK_COMEOUT_WROOM;
typedef class MSG_B2C_ANS_COMEOUT_WROOM // Size=13
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned char byResult; // Size=1 Offset=12
} *PMSG_B2C_ANS_COMEOUT_WROOM;
typedef class MSG_B2C_SEE_COMEOUT_WROOM // Size=16
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwComeoutPCID; // Size=4 Offset=12
} *PMSG_B2C_SEE_COMEOUT_WROOM;
typedef class MSG_C2B_ASK_EXIT_MEMBER // Size=16
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwExitMemberID; // Size=4 Offset=12
} *PMSG_C2B_ASK_EXIT_MEMBER;
typedef class MSG_B2C_ANS_EXIT_MEMBER // Size=13
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned char byResult; // Size=1 Offset=12
} *PMSG_B2C_ANS_EXIT_MEMBER;
typedef class MSG_B2C_SEE_EXIT_MEMBER // Size=16
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwExitMemberID; // Size=4 Offset=12
} *PMSG_B2C_SEE_EXIT_MEMBER;
typedef class MSG_B2C_GOTO_LOBBY // Size=12
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
} *PMSG_B2C_GOTO_LOBBY;
typedef class MSG_B2C_ASK_END_BATTLE // Size=17
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    int iWinTeamIndex; // Size=4 Offset=12
    unsigned char byEndMethod; // Size=1 Offset=16
} *PMSG_B2C_ASK_END_BATTLE;
typedef class MSG_C2B_ANS_END_BATTLE // Size=12
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
} *PMSG_C2B_ANS_END_BATTLE;
typedef class MSG_B2C_SVR_BATTLE_TIME // Size=12
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
} *PMSG_B2C_SVR_BATTLE_TIME;
typedef class MSG_C2B_ASK_CHANGE_WATCHER // Size=12
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
} *PMSG_C2B_ASK_CHANGE_WATCHER;
typedef class MSG_B2C_ANS_CHANGE_WATCHER // Size=13
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned char byResult; // Size=1 Offset=12
} *PMSG_B2C_ANS_CHANGE_WATCHER;
typedef class MSG_C2B_ASK_COMEOUT_BFIELD // Size=12
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
} *PMSG_C2B_ASK_COMEOUT_BFIELD;
typedef class MSG_B2C_ANS_COMEOUT_BFIELD // Size=13
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned char byResult; // Size=1 Offset=12
} *PMSG_B2C_ANS_COMEOUT_BFIELD;
typedef class MSG_B2C_SEE_HP_CHANGE // Size=22
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    int iTeam; // Size=4 Offset=12
    unsigned long dwPCID; // Size=4 Offset=16
    unsigned short wHP; // Size=2 Offset=20
} *PMSG_B2C_SEE_HP_CHANGE;
...
typedef class std::vector<bool,std::allocator<unsigned int> > // Size=20
{
    unsigned int _Size; // Size=4 Offset=0
    class std::vector<unsigned int,std::allocator<unsigned int> > _Vec; // Size=16 Offset=4
} *Pstd::vector<bool,std::allocator<unsigned int> >;
typedef struct std::_Ranit<bool,int> // Size=1
{
} *Pstd::_Ranit<bool,int>;
typedef class std::allocator<unsigned int> // Size=1
{
} *Pstd::allocator<unsigned int>;
typedef class std::vector<unsigned int,std::allocator<unsigned int> > // Size=16
{
    class std::allocator<unsigned int> allocator; // Size=1 Offset=0
    unsigned int * _First; // Size=4 Offset=4
    unsigned int * _Last; // Size=4 Offset=8
    unsigned int * _End; // Size=4 Offset=12
} *Pstd::vector<unsigned int,std::allocator<unsigned int> >;
typedef class std::reverse_iterator<std::vector<bool,std::allocator<unsigned int> >::const_iterator,bool,std::vector<bool,std::allocator<unsigned int> >::reference const ,std::vector<bool,std::allocator<unsigned int> >::reference const *,int> // Size=8
{
    class std::vector<bool,std::allocator<unsigned int> >::const_iterator current; // Size=8 Offset=0
} *Pstd::reverse_iterator<std::vector<bool,std::allocator<unsigned int> >::const_iterator,bool,std::vector<bool,std::allocator<unsigned int> >::reference const ,std::vector<bool,std::allocator<unsigned int> >::reference const *,int>;
typedef struct CClan::_CLANMEMBER_ // Size=20
{
    char szName[13]; // Size=13 Offset=0
    unsigned short wLevel; // Size=2 Offset=14
    unsigned char byRankInClan; // Size=1 Offset=16
    unsigned char byWorldLogin; // Size=1 Offset=17
    unsigned char byPCType; // Size=1 Offset=18
} *PCClan::_CLANMEMBER_;
typedef struct std::_Bidit<CClan *,int> // Size=1
{
} *Pstd::_Bidit<CClan *,int>;
typedef struct _CLAN_MSG_ // Size=40
{
    unsigned long dwClanID; // Size=4 Offset=0
    unsigned char byMsgNo; // Size=1 Offset=4
    long lRegisterTick; // Size=4 Offset=8
    long lAfterTick; // Size=4 Offset=12
    long lInterval; // Size=4 Offset=16
    int iRefCnt; // Size=4 Offset=20
    unsigned long dwExtra0; // Size=4 Offset=24
    unsigned long dwExtra1; // Size=4 Offset=28
    unsigned long dwExtra2; // Size=4 Offset=32
    unsigned long dwExtra3; // Size=4 Offset=36
} CLAN_MSG_, *PCLAN_MSG_;
typedef struct std::_Bidit<_CLAN_MSG_,int> // Size=1
{
} *Pstd::_Bidit<_CLAN_MSG_,int>;
typedef struct _CLAN_MS_MSG_ // Size=24
{
    unsigned char byMsgNo; // Size=1 Offset=0
    unsigned long dwClanID0; // Size=4 Offset=4
    unsigned long dwClanID1; // Size=4 Offset=8
    unsigned long dwExtra0; // Size=4 Offset=12
    unsigned long dwExtra1; // Size=4 Offset=16
    unsigned long dwExtra2; // Size=4 Offset=20
} CLAN_MS_MSG_, *PCLAN_MS_MSG_;
typedef struct std::_Bidit<_CLAN_MS_MSG_,int> // Size=1
{
} *Pstd::_Bidit<_CLAN_MS_MSG_,int>;
typedef class CClanManage // Size=36
{
    class std::list<CClan *,std::allocator<CClan *> > m_ClanList; // Size=12 Offset=0
    class std::list<_CLAN_MSG_,std::allocator<_CLAN_MSG_> > m_MsgList; // Size=12 Offset=12
    class std::list<_CLAN_MS_MSG_,std::allocator<_CLAN_MS_MSG_> > m_MSMsgList; // Size=12 Offset=24
} *PCClanManage;
typedef struct _MATCH_INFO_ // Size=20
{
    unsigned long dwClanID[2]; // Size=8 Offset=0
    unsigned char byWinTeam; // Size=1 Offset=8
    long lStartTime; // Size=4 Offset=12
    long lEndTime; // Size=4 Offset=16
} MATCH_INFO_, *PMATCH_INFO_;
typedef class CTMTree // Size=148
{
    unsigned long m_arrAppClan[8]; // Size=32 Offset=0
    int m_nAppClanCnt; // Size=4 Offset=32
    int m_bLoadAppTbl; // Size=4 Offset=36
    int m_bTmEnd; // Size=4 Offset=40
    int m_iNation; // Size=4 Offset=44
    int m_iShop; // Size=4 Offset=48
    class CTMNode m_arrNodes[4]; // Size=96 Offset=52
} *PCTMTree;
typedef struct _TMRESULT_ // Size=40
{
    unsigned long arrErrt[4]; // Size=32 Offset=0
    unsigned long arrToll[2]; // Size=8 Offset=32
} TMRESULT_, *PTMRESULT_;
...
typedef struct _START_POS_ // Size=16
{
    unsigned long cellIndex[4]; // Size=16 Offset=0
} START_POS_, *PSTART_POS_;
typedef struct CRoom::CMM_OPT // Size=8
{
    int nMaxTeam; // Size=4 Offset=0
    unsigned char byBattleType; // Size=1 Offset=4
    unsigned char byWatchAllowed; // Size=1 Offset=5
    unsigned char byTimeOut; // Size=1 Offset=6
} *PCRoom::CMM_OPT;
typedef struct CRoom::NRM_OPT // Size=8
{
    unsigned char byTeamDistribute; // Size=1 Offset=0
    unsigned char byLevelRestrict; // Size=1 Offset=1
    unsigned char byIsPrivate; // Size=1 Offset=2
    int nAllowedPC; // Size=4 Offset=4
} *PCRoom::NRM_OPT;
typedef struct std::_Bidit<CRoom *,int> // Size=1
{
} *Pstd::_Bidit<CRoom *,int>;
typedef class CRoomManage // Size=56
{
    class std::list<CRoom *,std::allocator<CRoom *> > m_BeginRoomList; // Size=12 Offset=0
    class std::list<CRoom *,std::allocator<CRoom *> > m_EndRoomList; // Size=12 Offset=12
    class std::list<CPC *,std::allocator<CPC *> > m_PvpPCList; // Size=12 Offset=24
    class CMapFile * m_pMapPool; // Size=4 Offset=36
    int m_nMapPoolSize; // Size=4 Offset=40
    class std::list<CRoom *,std::allocator<CRoom *> > m_RoomList; // Size=12 Offset=44
} *PCRoomManage;
...
typedef class std::reverse_iterator<unsigned int const *,unsigned int,unsigned int const &,unsigned int const *,int> // Size=0
{
} *Pstd::reverse_iterator<unsigned int const *,unsigned int,unsigned int const &,unsigned int const *,int>;
...
typedef class std::allocator<_CLAN_MSG_> // Size=1
{
} *Pstd::allocator<_CLAN_MSG_>;
typedef class std::reverse_bidirectional_iterator<std::list<_CLAN_MSG_,std::allocator<_CLAN_MSG_> >::iterator,_CLAN_MSG_,_CLAN_MSG_ &,_CLAN_MSG_ *,int> // Size=0
{
} *Pstd::reverse_bidirectional_iterator<std::list<_CLAN_MSG_,std::allocator<_CLAN_MSG_> >::iterator,_CLAN_MSG_,_CLAN_MSG_ &,_CLAN_MSG_ *,int>;
typedef struct std::not_equal_to<_CLAN_MSG_> // Size=1
{
} *Pstd::not_equal_to<_CLAN_MSG_>;
typedef struct std::greater<_CLAN_MSG_> // Size=1
{
} *Pstd::greater<_CLAN_MSG_>;
typedef class std::allocator<_CLAN_MS_MSG_> // Size=1
{
} *Pstd::allocator<_CLAN_MS_MSG_>;
typedef class std::reverse_bidirectional_iterator<std::list<_CLAN_MS_MSG_,std::allocator<_CLAN_MS_MSG_> >::iterator,_CLAN_MS_MSG_,_CLAN_MS_MSG_ &,_CLAN_MS_MSG_ *,int> // Size=0
{
} *Pstd::reverse_bidirectional_iterator<std::list<_CLAN_MS_MSG_,std::allocator<_CLAN_MS_MSG_> >::iterator,_CLAN_MS_MSG_,_CLAN_MS_MSG_ &,_CLAN_MS_MSG_ *,int>;
typedef struct std::not_equal_to<_CLAN_MS_MSG_> // Size=1
{
} *Pstd::not_equal_to<_CLAN_MS_MSG_>;
typedef struct std::greater<_CLAN_MS_MSG_> // Size=1
{
} *Pstd::greater<_CLAN_MS_MSG_>;
typedef class std::allocator<CRoom *> // Size=1
{
} *Pstd::allocator<CRoom *>;
typedef class std::reverse_bidirectional_iterator<std::list<CRoom *,std::allocator<CRoom *> >::iterator,CRoom *,CRoom * &,CRoom * *,int> // Size=0
{
} *Pstd::reverse_bidirectional_iterator<std::list<CRoom *,std::allocator<CRoom *> >::iterator,CRoom *,CRoom * &,CRoom * *,int>;
typedef struct std::not_equal_to<CRoom *> // Size=1
{
} *Pstd::not_equal_to<CRoom *>;
typedef struct std::greater<CRoom *> // Size=1
{
} *Pstd::greater<CRoom *>;
...
typedef struct std::iterator<std::random_access_iterator_tag,bool,int> // Size=1
{
} *Pstd::iterator<std::random_access_iterator_tag,bool,int>;
...
typedef struct std::less<unsigned char> // Size=1
{
} *Pstd::less<unsigned char>;
typedef class std::allocator<_ITEM_ *> // Size=1
{
} *Pstd::allocator<_ITEM_ *>;
typedef class std::reverse_bidirectional_iterator<std::_Tree<unsigned char,std::pair<unsigned char const ,_ITEM_ *>,std::map<unsigned char,_ITEM_ *,std::less<unsigned char>,std::allocator<_ITEM_ *> >::_Kfn,std::less<unsigned char>,std::allocator<_ITEM_ *> >::itadf67676 // Size=0
{
} *Pstd::reverse_bidirectional_iterator<std::_Tree<unsigned char,std::pair<unsigned char const ,_ITEM_ *>,std::map<unsigned char,_ITEM_ *,std::less<unsigned char>,std::allocator<_ITEM_ *> >::_Kfn,std::less<unsigned char>,std::allocator<_ITEM_ *> >::itadf67676;
typedef struct std::pair<std::_Tree<unsigned char,std::pair<unsigned char const ,_ITEM_ *>,std::map<unsigned char,_ITEM_ *,std::less<unsigned char>,std::allocator<_ITEM_ *> >::_Kfn,std::less<unsigned char>,std::allocator<_ITEM_ *> >::iterator,bool> // Size=8
{
    class std::_Tree<unsigned char,std::pair<unsigned char const ,_ITEM_ *>,std::map<unsigned char,_ITEM_ *,std::less<unsigned char>,std::allocator<_ITEM_ *> >::_Kfn,std::less<unsigned char>,std::allocator<_ITEM_ *> >::iterator first; // Size=4 Offset=0
    unsigned char second; // Size=1 Offset=4
} *Pstd::pair<std::_Tree<unsigned char,std::pair<unsigned char const ,_ITEM_ *>,std::map<unsigned char,_ITEM_ *,std::less<unsigned char>,std::allocator<_ITEM_ *> >::_Kfn,std::less<unsigned char>,std::allocator<_ITEM_ *> >::iterator,bool>;
...
typedef struct std::binary_function<_CLAN_MS_MSG_,_CLAN_MS_MSG_,bool> // Size=1
{
} *Pstd::binary_function<_CLAN_MS_MSG_,_CLAN_MS_MSG_,bool>;
...
typedef struct std::binary_function<CRoom *,CRoom *,bool> // Size=1
{
} *Pstd::binary_function<CRoom *,CRoom *,bool>;
...
typedef struct std::iterator<std::bidirectional_iterator_tag,_CLAN_MSG_,int> // Size=1
{
} *Pstd::iterator<std::bidirectional_iterator_tag,_CLAN_MSG_,int>;
...
typedef struct std::iterator<std::bidirectional_iterator_tag,CRoom *,int> // Size=1
{
} *Pstd::iterator<std::bidirectional_iterator_tag,CRoom *,int>;
typedef struct std::unary_function<CRoom *,bool> // Size=1
{
} *Pstd::unary_function<CRoom *,bool>;
typedef struct std::iterator<std::bidirectional_iterator_tag,_CLAN_MS_MSG_,int> // Size=1
{
} *Pstd::iterator<std::bidirectional_iterator_tag,_CLAN_MS_MSG_,int>;
typedef struct std::unary_function<_CLAN_MSG_,bool> // Size=1
{
} *Pstd::unary_function<_CLAN_MSG_,bool>;
typedef struct std::unary_function<_CLAN_MS_MSG_,bool> // Size=1
{
} *Pstd::unary_function<_CLAN_MS_MSG_,bool>;
typedef struct std::unary_function<_LOG_DATA_ *,bool> // Size=1
{
} *Pstd::unary_function<_LOG_DATA_ *,bool>;
typedef struct std::binary_function<_CLAN_MSG_,_CLAN_MSG_,bool> // Size=1
{
} *Pstd::binary_function<_CLAN_MSG_,_CLAN_MSG_,bool>;
...
typedef struct tagEXCEPINFO // Size=32
{
    ...
    long ( * pfnDeferredFillIn)(struct tagEXCEPINFO *); // Size=4 Offset=24
...
typedef struct ___unnamed1091 // Size=12
{
    void * pad[2]; // Size=8 Offset=0
    void * userContext; // Size=4 Offset=8
} __unnamed1091, *P__unnamed1091;
...
typedef class CLobby // Size=12
{
    class std::list<CPC *,std::allocator<CPC *> > m_PCList; // Size=12 Offset=0
} *PCLobby;
...
typedef struct _CERT_REVOCATION_INFO // Size=16
{
    unsigned long cbSize; // Size=4 Offset=0
...
typedef union _LARGE_INTEGER // Size=8
{
    ...
    struct _LARGE_INTEGER::___unnamed71 u; // Size=8 Offset=0
...
typedef union _ULARGE_INTEGER // Size=8
{
    ...
    struct _ULARGE_INTEGER::___unnamed74 u; // Size=8 Offset=0
...
{
    union in_addr::___unnamed125 S_un; // Size=4 Offset=0
} *Pin_addr;
...
typedef struct _PC_STAT_UPDATE_ // Size=44
{
    ...
    struct _PC_2STAT_ PC2ndStat; // Size=24 Offset=20
...
typedef class MSG_S2C_SET_PC2STAT // Size=37
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    struct _PC_2STAT_ PC2ndStat; // Size=24 Offset=12
    unsigned char byStatCode; // Size=1 Offset=36
...
typedef class MSG_S2C_ACTIVE_PET // Size=45
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    ...
    struct _PC_2STAT_ PC2ndStat; // Size=24 Offset=21
} *PMSG_S2C_ACTIVE_PET;
typedef class MSG_S2C_INACTIVE_PET // Size=41
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwInactPetID; // Size=4 Offset=12
    unsigned char petIndex; // Size=1 Offset=16
    struct _PC_2STAT_ PC2ndStat; // Size=24 Offset=17
...
typedef class MSG_S2C_PET_DIE // Size=40
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned long dwPetID; // Size=4 Offset=12
    struct _PC_2STAT_ PC2ndStat; // Size=24 Offset=16
} *PMSG_S2C_PET_DIE;
...
typedef struct _ROOM_MAKE_DATA_ // Size=77
{
    char szTitle[64]; // Size=64 Offset=0
    char szPassWord[8]; // Size=8 Offset=64
    unsigned char byMapIndex; // Size=1 Offset=72
    struct _ROOM_OPT_ Opt; // Size=4 Offset=73
} ROOM_MAKE_DATA_, *PROOM_MAKE_DATA_;
typedef struct _ROOM_VIEW_DATA_ // Size=86
{
    unsigned long dwRoomID; // Size=4 Offset=0
    char szTitle[64]; // Size=64 Offset=4
    char szOwner[13]; // Size=13 Offset=68
    unsigned char byMapIndex; // Size=1 Offset=81
    struct _ROOM_OPT_ Opt; // Size=4 Offset=82
} ROOM_VIEW_DATA_, *PROOM_VIEW_DATA_;
typedef class MSG_B2C_SEE_WROOM_INFO // Size=1416
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    struct _WROOM_PC_DATA_ WRoomPC[26]; // Size=1404 Offset=12
} *PMSG_B2C_SEE_WROOM_INFO;
...
typedef struct CPC::PCINFO4BATTLE // Size=32
{
    unsigned long dwRoomID; // Size=4 Offset=0
    int iTeam; // Size=4 Offset=4
    int bReadyOK; // Size=4 Offset=8
    int bMapReserved; // Size=4 Offset=12
    unsigned long dwPvpPCID; // Size=4 Offset=16
    enum PC_BATTLE_LOC emPCLoc; // Size=4 Offset=20
    unsigned short wPreMapIndex; // Size=2 Offset=24
    unsigned long dwPreCellIndex; // Size=4 Offset=28
} *PCPC::PCINFO4BATTLE;
...
typedef class CClan // Size=340
{
    unsigned long m_dwClanID; // Size=4 Offset=0
    unsigned long m_dwMarkID; // Size=4 Offset=4
    unsigned long m_dwCDate; // Size=4 Offset=8
    unsigned long m_dwDDate; // Size=4 Offset=12
    char m_szName[32]; // Size=32 Offset=16
    char m_szPass[16]; // Size=16 Offset=48
    unsigned char m_byNation; // Size=1 Offset=64
    unsigned char m_byClanRank; // Size=1 Offset=65
    unsigned char m_byClanStat; // Size=1 Offset=66
    unsigned short m_wStorageIndex; // Size=2 Offset=68
    unsigned short m_wAgitID; // Size=2 Offset=70
    unsigned short m_wWinCnt; // Size=2 Offset=72
    unsigned short m_wLooseCnt; // Size=2 Offset=74
    int m_iTeam; // Size=4 Offset=76
    struct CClan::_CLANMEMBER_ m_Member[13]; // Size=260 Offset=80
} *PCClan;
...
typedef class std::list<_CLAN_MSG_,std::allocator<_CLAN_MSG_> > // Size=12
{
    class std::allocator<_CLAN_MSG_> allocator; // Size=1 Offset=0
    struct std::list<_CLAN_MSG_,std::allocator<_CLAN_MSG_> >::_Node * _Head; // Size=4 Offset=4
    unsigned int _Size; // Size=4 Offset=8
} *Pstd::list<_CLAN_MSG_,std::allocator<_CLAN_MSG_> >;
typedef class std::list<_CLAN_MS_MSG_,std::allocator<_CLAN_MS_MSG_> > // Size=12
{
    class std::allocator<_CLAN_MS_MSG_> allocator; // Size=1 Offset=0
    struct std::list<_CLAN_MS_MSG_,std::allocator<_CLAN_MS_MSG_> >::_Node * _Head; // Size=4 Offset=4
    unsigned int _Size; // Size=4 Offset=8
} *Pstd::list<_CLAN_MS_MSG_,std::allocator<_CLAN_MS_MSG_> >;
typedef class CTMNode // Size=24
{
    struct _MATCH_INFO_ m_MI; // Size=20 Offset=0
    unsigned long m_dwRoomID; // Size=4 Offset=20
} *PCTMNode;
...
typedef class CTeam // Size=24
{
    class std::list<CPC *,std::allocator<CPC *> > m_PCList; // Size=12 Offset=0
    int m_bIsClosed; // Size=4 Offset=12
    unsigned long m_dwClanID; // Size=4 Offset=16
    enum GAME_RESULT_FLAG m_enmGameFlag; // Size=4 Offset=20
} *PCTeam;
typedef class std::list<CRoom *,std::allocator<CRoom *> > // Size=12
{
    class std::allocator<CRoom *> allocator; // Size=1 Offset=0
    struct std::list<CRoom *,std::allocator<CRoom *> >::_Node * _Head; // Size=4 Offset=4
    unsigned int _Size; // Size=4 Offset=8
} *Pstd::list<CRoom *,std::allocator<CRoom *> >;
...
typedef class std::binder2nd<std::not_equal_to<CRoom *> > // Size=8
{
    struct std::not_equal_to<CRoom *> op; // Size=1 Offset=0
    class CRoom * value; // Size=4 Offset=4
} *Pstd::binder2nd<std::not_equal_to<CRoom *> >;
...
typedef class CTMManage // Size=1708
{
    class CTMTree m_arrThisWeek[4]; // Size=1184 Offset=0
    class CTMTree m_arrToll[2]; // Size=296 Offset=1184
    struct _TMRESULT_ m_PreWeek; // Size=40 Offset=1480
    struct _TMRESULT_ m_CurWeek; // Size=40 Offset=1520
    unsigned long m_arrCurWeekWinner[4]; // Size=32 Offset=1560
    unsigned long m_FinalClan[2]; // Size=16 Offset=1592
    unsigned char m_byNowWhat; // Size=1 Offset=1608
    int m_bInited; // Size=4 Offset=1612
    int m_bTMClosed; // Size=4 Offset=1616
    int m_bAskPreWeekData; // Size=4 Offset=1620
    int m_bGetPreWeekData; // Size=4 Offset=1624
    int m_bPrepare; // Size=4 Offset=1628
    int m_bBegin; // Size=4 Offset=1632
    int m_bEnd; // Size=4 Offset=1636
    int m_bPostproc; // Size=4 Offset=1640
    long m_lBattleTimes; // Size=4 Offset=1644
    long m_lBroadcastTime; // Size=4 Offset=1648
    long m_lIdleTime; // Size=4 Offset=1652
    long m_lFirstGameTime; // Size=4 Offset=1656
    long m_lTMCloseTick; // Size=4 Offset=1660
    int m_nReignCmd; // Size=4 Offset=1664
    unsigned long m_ReignTmp[5]; // Size=40 Offset=1668
} *PCTMManage;
...
{
    struct in_addr::___unnamed126::___unnamed126 S_un_b; // Size=4 Offset=0
    struct in_addr::___unnamed127::___unnamed127 S_un_w; // Size=4 Offset=0
...
typedef class MSG_S2C_PC_LEVELUP // Size=58
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned short wLevel; // Size=2 Offset=12
    struct _PC_STAT_UPDATE_ PCStatUpdate; // Size=44 Offset=14
} *PMSG_S2C_PC_LEVELUP;
typedef class MSG_S2C_ALLOT_POINT // Size=56
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    struct _PC_STAT_UPDATE_ PCStatUpdate; // Size=44 Offset=12
...
typedef class MSG_S2C_WEAR_ITEM // Size=54
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    ...
    struct _PC_2STAT_ PC2ndStat; // Size=24 Offset=30
} *PMSG_S2C_WEAR_ITEM;
typedef class MSG_S2C_STRIP_ITEM // Size=45
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    struct _ITEM_ID_ ItemID; // Size=8 Offset=12
    unsigned char invenIndex; // Size=1 Offset=20
...
typedef class MSG_C2B_ASK_CREATE_ROOM // Size=89
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    struct _ROOM_MAKE_DATA_ RoomMakeData; // Size=77 Offset=12
} *PMSG_C2B_ASK_CREATE_ROOM;
typedef class MSG_B2C_SEE_LOBBY_INFO // Size=872
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    struct _ROOM_VIEW_DATA_ RoomViewData[10]; // Size=860 Offset=12
} *PMSG_B2C_SEE_LOBBY_INFO;
typedef class MSG_B2C_WROOM_DATA // Size=98
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    struct _ROOM_VIEW_DATA_ RoomViewData; // Size=86 Offset=12
} *PMSG_B2C_WROOM_DATA;
...
typedef class CPCManage // Size=12400
{
    int m_iPCCnt; // Size=4 Offset=0
    class std::map<unsigned long,CPC *,std::less<unsigned long>,std::allocator<CPC *> > m_PCTable[5]; // Size=320 Offset=4
    class std::list<CPC *,std::allocator<CPC *> > m_NameTable[1000]; // Size=12000 Offset=324
    class std::list<CPC *,std::allocator<CPC *> > m_PCFreeList; // Size=12 Offset=12324
    class std::list<CPC *,std::allocator<CPC *> > m_standbyPCList; // Size=12 Offset=12336
    class CLinkedList m_WarpWaitPCList[2]; // Size=16 Offset=12348
    class std::list<CPC *,std::allocator<CPC *> > m_LogoutPCList; // Size=12 Offset=12364
    struct _RTL_CRITICAL_SECTION m_cs; // Size=24 Offset=12376
} *PCPCManage;
typedef class CMapFile // Size=2359448
{
    unsigned short m_wZbIndex; // Size=2 Offset=0
    char m_szName[20]; // Size=20 Offset=2
########################################
    struct _START_POS_ m_StartPos; // Size=16 Offset=2359432
} *PCMapFile;
...
typedef class CAStar // Size=544
{
    int m_nPathNum; // Size=4 Offset=4
    unsigned long m_arrPath[128]; // Size=512 Offset=8
    int m_DestX; // Size=4 Offset=520
    int m_DestY; // Size=4 Offset=524
    int DIRNUM; // Size=4 Offset=528
    struct CAStar::__NODE * OPEN; // Size=4 Offset=532
    struct CAStar::__NODE * CLOSED; // Size=4 Offset=536
    struct CAStar::__STACK * Stack; // Size=4 Offset=540
} *PCAStar;
...
typedef class std::binder2nd<std::not_equal_to<_CLAN_MSG_> > // Size=44
{
    struct std::not_equal_to<_CLAN_MSG_> op; // Size=1 Offset=0
    struct _CLAN_MSG_ value; // Size=40 Offset=4
} *Pstd::binder2nd<std::not_equal_to<_CLAN_MSG_> >;
typedef class std::binder2nd<std::not_equal_to<_CLAN_MS_MSG_> > // Size=28
{
    struct std::not_equal_to<_CLAN_MS_MSG_> op; // Size=1 Offset=0
    struct _CLAN_MS_MSG_ value; // Size=24 Offset=4
} *Pstd::binder2nd<std::not_equal_to<_CLAN_MS_MSG_> >;
...
typedef struct _CRYPT_PROVIDER_FUNCTIONS // Size=64
{
    ...
    long ( * pfnInitialize)(struct _CRYPT_PROVIDER_DATA *); // Size=4 Offset=28
    long ( * pfnObjectTrust)(struct _CRYPT_PROVIDER_DATA *); // Size=4 Offset=32
    long ( * pfnSignatureTrust)(struct _CRYPT_PROVIDER_DATA *); // Size=4 Offset=36
    long ( * pfnCertificateTrust)(struct _CRYPT_PROVIDER_DATA *); // Size=4 Offset=40
    long ( * pfnFinalPolicy)(struct _CRYPT_PROVIDER_DATA *); // Size=4 Offset=44
    int ( * pfnCertCheckPolicy)(struct _CRYPT_PROVIDER_DATA *,unsigned long,int,unsigned long); // Size=4 Offset=48
    long ( * pfnTestFinalPolicy)(struct _CRYPT_PROVIDER_DATA *); // Size=4 Offset=52
    struct _CRYPT_PROVUI_FUNCS * psUIpfns; // Size=4 Offset=56
    long ( * pfnCleanupPolicy)(struct _CRYPT_PROVIDER_DATA *); // Size=4 Offset=60
} CRYPT_PROVIDER_FUNCTIONS, *PCRYPT_PROVIDER_FUNCTIONS;
typedef struct _CRYPT_PROVIDER_CERT // Size=56
{
    unsigned long cbStruct; // Size=4 Offset=0
...
typedef struct _CERT_CHAIN_CONTEXT // Size=20
{
    unsigned long cbSize; // Size=4 Offset=0
...
typedef struct _RPC_ASYNC_STATE // Size=68
{
    ...
    union _RPC_ASYNC_STATE::___unnamed907 u; // Size=16 Offset=36
...
{
    struct _FULL_PTR_XLAT_TABLES::___unnamed1088 RefIdToPointer; // Size=12 Offset=0
    struct _FULL_PTR_XLAT_TABLES::___unnamed1089 PointerToRefId; // Size=12 Offset=12
...
typedef struct _CERT_SIMPLE_CHAIN // Size=24
{
    unsigned long cbSize; // Size=4 Offset=0
    struct _CERT_TRUST_STATUS TrustStatus; // Size=8 Offset=4
...
typedef struct _CERT_CHAIN_ELEMENT // Size=20
{
    unsigned long cbSize; // Size=4 Offset=0
...
typedef class MSG_S2C_PC_APPEAR // Size=121
{
    ...
    unsigned char byWearFlag; // Size=1 Offset=120
} *PMSG_S2C_PC_APPEAR;
...
typedef class CRoom // Size=2359708
{
    unsigned long m_dwRoomID; // Size=4 Offset=0
    class CPC * m_pBossPC; // Size=4 Offset=4
    char m_szTitle[64]; // Size=64 Offset=8
    char m_szMapName[20]; // Size=20 Offset=72
    char m_szPassWord[9]; // Size=9 Offset=92
########################################
    class std::map<unsigned long,_ITEM_ *,std::less<unsigned long>,std::allocator<_ITEM_ *> > m_ItemMap; // Size=16 Offset=2359512
    unsigned short m_wZbIndex; // Size=2 Offset=2359528
    struct _START_POS_ m_StartPos; // Size=16 Offset=2359532
    class CTeam m_Teams[4]; // Size=96 Offset=2359548
    class std::list<CPC *,std::allocator<CPC *> > m_WatchList; // Size=12 Offset=2359644
    unsigned char m_byRoomState; // Size=1 Offset=2359656
    int m_bTransferedMapInfo; // Size=4 Offset=2359660
    int m_bAllEntered; // Size=4 Offset=2359664
    struct CRoom::CMM_OPT m_OptCMM; // Size=8 Offset=2359668
    struct CRoom::NRM_OPT m_OptNRM; // Size=8 Offset=2359676
    long m_lStartTimeTick; // Size=4 Offset=2359684
    long m_lEndTimeTick; // Size=4 Offset=2359688
    int m_bEndBattle; // Size=4 Offset=2359692
    int m_bEliminateRoom; // Size=4 Offset=2359696
    int m_bIsPvpRoom; // Size=4 Offset=2359700
    int m_bIsTmRoom; // Size=4 Offset=2359704
} *PCRoom;
...
{
    struct _RPC_ASYNC_STATE::___unnamed995::___unnamed995 APC; // Size=8 Offset=0
    struct _RPC_ASYNC_STATE::___unnamed997::___unnamed997 IOC; // Size=16 Offset=0
    struct _RPC_ASYNC_STATE::___unnamed999::___unnamed999 HWND; // Size=8 Offset=0
...
typedef struct _MIDL_STUB_DESC // Size=80
{
    ...
    void ( * pfnFree)(void *); // Size=4 Offset=8
    union _MIDL_STUB_DESC::___unnamed1076 IMPLICIT_HANDLE_INFO; // Size=4 Offset=12
    ...
    unsigned long Reserved3; // Size=4 Offset=68
    unsigned long Reserved4; // Size=4 Offset=72
...
typedef struct _MIDL_STUB_MESSAGE // Size=200
{
    ...
    unsigned long ulUnused1; // Size=4 Offset=108
    struct
    {
    ...
    struct ___unnamed924 * * SavedContextHandles; // Size=4 Offset=124
    ...
    unsigned long w2kReserved[5]; // Size=20 Offset=180
...
typedef struct _CRYPT_PROVIDER_DATA // Size=120
{
    unsigned long cbStruct; // Size=4 Offset=0
...
typedef class CPC // Size=1004
{
    ...
    struct _PET_INFO_ * m_PetActive; // Size=4 Offset=192
    struct _PET_INFO_ * m_PetInven[5]; // Size=20 Offset=196
    struct _ITEM_ * m_ItemInWear[10]; // Size=40 Offset=216
    struct _ITEM_ * m_ItemInInven[30]; // Size=120 Offset=256
    class std::map<unsigned char,_ITEM_ *,std::less<unsigned char>,std::allocator<_ITEM_ *> > m_DealItemMap; // Size=16 Offset=376
    struct _PET_INFO_ * m_arrDealPet[2]; // Size=8 Offset=392
    unsigned long m_dwDealMoney; // Size=4 Offset=400
    unsigned long m_dwDealPC; // Size=4 Offset=404
    unsigned short m_wDealHP; // Size=2 Offset=408
    unsigned short m_wDealMP; // Size=2 Offset=410
    unsigned char m_bDealOK; // Size=1 Offset=412
    unsigned char m_bDealConfirm; // Size=1 Offset=413
    struct _GAME_OPTION_ m_option; // Size=1 Offset=414
    unsigned long m_dwStepTime; // Size=4 Offset=416
    unsigned long m_dwPreNPCID; // Size=4 Offset=420
    unsigned long m_dwPrePCID; // Size=4 Offset=424
    unsigned char m_byCurrentStep; // Size=1 Offset=428
    class CPC::CPCStatChange m_PCStatChange; // Size=20 Offset=432
    struct _LASTINGSKILL_MANAGEARRARY_ m_PCSkillCasted; // Size=48 Offset=452
    char m_szAccountName[21]; // Size=21 Offset=500
    unsigned long m_dwLore; // Size=4 Offset=524
    unsigned short m_wLastQuest; // Size=2 Offset=528
    unsigned long m_dwLastRTime; // Size=4 Offset=532
    unsigned long m_byFatiguePt; // Size=4 Offset=536
    struct _PC_QUEST_INFO_ * m_pQuestInfo; // Size=4 Offset=540
    class CCheckHACK m_CheckHack; // Size=36 Offset=544
    struct CPC::_REMEMBER_ENEMY_ m_arrEnemy[16]; // Size=384 Offset=580
    struct CPC::PCINFO4BATTLE m_BI; // Size=32 Offset=964
    unsigned long m_dwClanID; // Size=4 Offset=996
    unsigned long m_dwMarkID; // Size=4 Offset=1000
} *PCPC;
...
typedef class MSG_B2C_ANS_WARP_Z2B // Size=941
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    unsigned char byResult; // Size=1 Offset=12
    struct _BATTLE_WARP_DATA_ BtWarpData; // Size=8 Offset=13
    union _ITEM_IN_WEAR_ WearList[10]; // Size=200 Offset=21
    union _ITEM_IN_INVEN_ HaveList[30]; // Size=600 Offset=221
    struct _PET_INFO_ PetActive; // Size=20 Offset=821
    struct _PET_INFO_ PetInven[5]; // Size=100 Offset=841
} *PMSG_B2C_ANS_WARP_Z2B;
...
typedef class MSG_S2C_WORLD_LOGIN // Size=1036
{
    class MSG_S2C_HEADER MsgHeader; // Size=12 Offset=0
    struct _PC_INFO_ PCInfo; // Size=60 Offset=12
    struct _PC_STAT_UPDATE_ PCStatUpdate; // Size=44 Offset=72
    union _ITEM_IN_WEAR_ WearList[10]; // Size=200 Offset=116
    union _ITEM_IN_INVEN_ HaveList[30]; // Size=600 Offset=316
    struct _PET_INFO_ PetActive; // Size=20 Offset=916
    struct _PET_INFO_ PetInven[5]; // Size=100 Offset=936
