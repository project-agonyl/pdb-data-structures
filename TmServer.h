// TmServer.h
// Recovered layout header generated from TmServer.map, TmServer.exe, TmServer.pdb, and the VC6 companion vc60.pdb.
// TmServer.pdb contains public/source symbol data; member layouts are recovered from vc60.pdb type records and filtered by TmServer.map usage.
// Offsets and sizes are PDB-derived. STL/CRT/container internals are emitted as opaque byte ranges when needed.

#ifndef TMSERVER_RECOVERED_H
#define TMSERVER_RECOVERED_H
...
#if defined(__cplusplus) && ((defined(_MSVC_LANG) && _MSVC_LANG >= 201103L) || (__cplusplus >= 201103L))
#define TM_STATIC_ASSERT_SIZE(type_name, expected_size) static_assert(sizeof(type_name) == (expected_size), "size mismatch: " #type_name)
#else
#define TM_STATIC_ASSERT_SIZE(type_name, expected_size)
#endif
...
TM_STATIC_ASSERT_SIZE(CLoopThread, 0x10);
...
TM_STATIC_ASSERT_SIZE(_ITEM_ID_, 0x8);
...
TM_STATIC_ASSERT_SIZE(_ITEM_INFO_, 0x4);
...
TM_STATIC_ASSERT_SIZE(_ITEM_, 0x10);
...
TM_STATIC_ASSERT_SIZE(_PET_ID_, 0x8);
...
TM_STATIC_ASSERT_SIZE(_LASTINGSKILL_INFO_, 0xC);
...
TM_STATIC_ASSERT_SIZE(_SKILL_LEVEL_DATA_, 0x1B);
...
TM_STATIC_ASSERT_SIZE(SKILL_STAT_CHANGE, 0xB);
...
TM_STATIC_ASSERT_SIZE(_SAVE_QUEST_INFO____SAVE_QUEST_DATA_, 0x1);
...
TM_STATIC_ASSERT_SIZE(_SKILL_, 0xC);
...
TM_STATIC_ASSERT_SIZE(_SOCIALINFO_, 0x4);
...
TM_STATIC_ASSERT_SIZE(_ITEM_IN_WEAR_, 0x14);
...
TM_STATIC_ASSERT_SIZE(_ITEM_IN_INVEN_, 0x14);
...
TM_STATIC_ASSERT_SIZE(_PET_INFO_, 0x14);
...
TM_STATIC_ASSERT_SIZE(_SAVE_QUEST_INFO_, 0xC);
...
TM_STATIC_ASSERT_SIZE(_PC_2STAT_, 0x18);
...
TM_STATIC_ASSERT_SIZE(_ROOM_OPT_, 0x4);
...
TM_STATIC_ASSERT_SIZE(_CLAN_MEMBER_, 0x16);
...
TM_STATIC_ASSERT_SIZE(CBaseServer, 0x800078);
...
TM_STATIC_ASSERT_SIZE(MSG_S2G_HEADER, 0xA);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_HEADER, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ERROR, 0x4E);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_UNKNOWN_CHAR, 0x13);
...
TM_STATIC_ASSERT_SIZE(_ITEM_APPEAR_, 0x4);
...
TM_STATIC_ASSERT_SIZE(_PET_APPEAR_, 0x4);
...
TM_STATIC_ASSERT_SIZE(_SKILL_CAST_, 0x3);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_PC_APPEAR, 0x79);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_PC_DISAPPEAR, 0x10);
...
TM_STATIC_ASSERT_SIZE(_PC_STAT_UPDATE_, 0x2C);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ANS_MOVE, 0x12);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SEE_MOVE, 0x19);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_FIX_MOVE, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SEE_STOP, 0x14);
...
TM_STATIC_ASSERT_SIZE(_PET_STAT_, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_STAT_AUTOUPDATE, 0x6E);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_PET_LEVELUP, 0x11);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_USE_ITEM, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_BUY_ITEM, 0x21);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_NPC_APPEAR, 0x34);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_NPC_DISAPPEAR, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_NPC_MOVE, 0x34);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_NPC_STATE, 0x13);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_NPC_ATTACK, 0x26);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SEE_NPC_ATTACK, 0x22);
...
TM_STATIC_ASSERT_SIZE(_NPC_SKILL_DAMAGEINFO_, 0x9);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SEE_NPC_SKILLATTACK, 0xFB);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ANS_ATTACK, 0x22);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SEE_ATTACK, 0x20);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_UPDATE_PKCOUNT, 0xF);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_UPDATE_PCEXP, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SKILL_DELAY_INFO, 0x2C);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_LEARN_SKILL, 0x17);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ERR_SKILL, 0xE);
...
TM_STATIC_ASSERT_SIZE(_SKILL_DAMAGEINFO_, 0xA);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_DONE_SKILL, 0x116);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_GET_SKILL, 0x1C);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SEE_SKILL, 0x112);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_CAST_SKILL, 0x16);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_LASTING_SKILL, 0x1F);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SEE_LASTING_SKILL, 0x1C);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_PC_LEVELUP, 0x3A);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SEE_LEVELUP, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ALLOT_POINT, 0x38);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ITEM_APPEAR, 0x21);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ITEM_DISAPPEAR, 0x18);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_PICKUP_ITEM, 0x1D);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_DROP_ITEM, 0x19);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_MOVE_ITEM, 0x1E);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SEE_WEAR, 0x14);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_WEAR_ITEM, 0x36);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SEE_STRIP, 0x13);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_STRIP_ITEM, 0x2D);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SELL_ITEM, 0x19);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_GIVE_ITEM, 0x15);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_GIVEN_ITEM, 0x2A);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_USE_POTION, 0x11);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ASK_DEAL, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ANS_DEAL, 0x11);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_PUTIN_ITEM, 0x24);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_PUTOUT_ITEM, 0x1C);

// class MSG_S2C_DECIDE_DEAL; size: 0xC
struct MSG_S2C_DECIDE_DEAL {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_S2C_DECIDE_DEAL, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SUCCESS_DEAL, 0x1A4);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_FAIL_DEAL, 0xD);

// class MSG_S2C_PEAR_DECIDE; size: 0xC
struct MSG_S2C_PEAR_DECIDE {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_S2C_PEAR_DECIDE, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_PUTIN_PET, 0x20);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_PUTOUT_PET, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SUCCESS_DEAL_PET, 0x34);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_CONFIRM_ITEM, 0x21);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_REMODEL_ITEM, 0x1E);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SET_PC2STAT, 0x25);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_SAY, 0x5A);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SAY, 0x5E);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ANS_HEAL, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_PC_ATTACK, 0x1B);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ACTIVE_PET, 0x2D);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_INACTIVE_PET, 0x29);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SEE_PET, 0x15);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_PET_DIE, 0x28);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_FEED_PET, 0x1C);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_UPDATE_MONEY, 0x11);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_REVIVE_PET, 0x20);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SVR_TIME, 0xE);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_GESTURE, 0x11);
...
TM_STATIC_ASSERT_SIZE(_GAME_OPTION_, 0x1);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_OPTION, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_SUBMAP_INFO, 0x25);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_ENTER, 0x13);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_OTHER_UPDATE, 0x12);

// class MSG_S2S_HEADER; size: 0x2
struct MSG_S2S_HEADER {
    /* 0x0000 */ uint16_t wProtocol;
};
TM_STATIC_ASSERT_SIZE(MSG_S2S_HEADER, 0x2);
...
TM_STATIC_ASSERT_SIZE(MSG_S2M_SVR_LOGIN, 0x3);
...
TM_STATIC_ASSERT_SIZE(_PCDATA_, 0x414);
...
TM_STATIC_ASSERT_SIZE(MSG_S2M_CHAR_LOGOUT, 0x41A);
...
TM_STATIC_ASSERT_SIZE(MSG_S2M_DATA_UPDATE, 0x41A);
...
TM_STATIC_ASSERT_SIZE(MSG_M2S_PASS2GATE, 0x107);
...
TM_STATIC_ASSERT_SIZE(MSG_S2M_SAY, 0x62);
...
TM_STATIC_ASSERT_SIZE(MSG_M2S_ADMIN, 0x4B);

// class MSG_S2G_DISCONNECT; size: 0xA
struct MSG_S2G_DISCONNECT {
    /* 0x0000 */ MSG_S2G_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_S2G_DISCONNECT, 0xA);
...
TM_STATIC_ASSERT_SIZE(MSG_S2G_SWITCH_ZONE, 0xB);

// class MSG_S2G_BROADCAST; size: 0xA
struct MSG_S2G_BROADCAST {
    /* 0x0000 */ MSG_S2G_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_S2G_BROADCAST, 0xA);
...
TM_STATIC_ASSERT_SIZE(MSG_S2M_OP_CMD, 0x55);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_WARP_READY, 0xE);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_WARP, 0xE);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_WARP, 0x10);

// class MSG_C2B_ASK_WARP_Z2B; size: 0xC
struct MSG_C2B_ASK_WARP_Z2B {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_C2B_ASK_WARP_Z2B, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_B2M_ASK_WARP_Z2B, 0x7);
...
TM_STATIC_ASSERT_SIZE(_CLAN_DATA_, 0x16C);
...
TM_STATIC_ASSERT_SIZE(_BATTLE_WARP_DATA_, 0x8);
...
TM_STATIC_ASSERT_SIZE(MSG_M2B_ANS_WARP_Z2B, 0x59F);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_ANS_WARP_Z2B, 0x3AD);

// class MSG_C2B_ASK_WARP_B2Z; size: 0xC
struct MSG_C2B_ASK_WARP_B2Z {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_C2B_ASK_WARP_B2Z, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_B2M_ASK_WARP_B2Z, 0x41B);
...
TM_STATIC_ASSERT_SIZE(MSG_M2B_ANS_WARP_B2Z, 0x8);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_ANS_WARP_B2Z, 0xF);
...
TM_STATIC_ASSERT_SIZE(_ROOM_MAKE_DATA_, 0x4D);
...
TM_STATIC_ASSERT_SIZE(MSG_C2B_ASK_CREATE_ROOM, 0x59);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_ANS_CREATE_ROOM, 0x11);
...
TM_STATIC_ASSERT_SIZE(MSG_C2B_ASK_ENTER_ROOM, 0x59);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_ANS_ENTER_ROOM, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_SEE_ENTER_ROOM, 0x41);
...
TM_STATIC_ASSERT_SIZE(MSG_C2B_ASK_LOBBY_INFO, 0x15);
...
TM_STATIC_ASSERT_SIZE(_ROOM_VIEW_DATA_, 0x56);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_SEE_LOBBY_INFO, 0x368);
...
TM_STATIC_ASSERT_SIZE(_WROOM_PC_DATA_, 0x36);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_SEE_WROOM_INFO, 0x588);
...
TM_STATIC_ASSERT_SIZE(MSG_C2B_ASK_CHANGE_TEAM, 0x11);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_ANS_CHANGE_TEAM, 0xE);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_SEE_CHANGE_TEAM, 0x18);
...
TM_STATIC_ASSERT_SIZE(MSG_C2B_READYOK_BATTLE, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_SEE_READYOK_BATTLE, 0x11);

// class MSG_C2B_ASK_START_BATTLE; size: 0xC
struct MSG_C2B_ASK_START_BATTLE {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_C2B_ASK_START_BATTLE, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_ANS_START_BATTLE, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_START_BATTLE, 0xD);

// class MSG_C2B_MAPLOAD_OK; size: 0xC
struct MSG_C2B_MAPLOAD_OK {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_C2B_MAPLOAD_OK, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_YOURCELL_IS_THIS, 0x10);

// class MSG_B2C_ALL_ENTERED; size: 0xC
struct MSG_B2C_ALL_ENTERED {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_B2C_ALL_ENTERED, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_CHANGE_BOSS, 0x10);

// class MSG_C2B_ASK_COMEOUT_WROOM; size: 0xC
struct MSG_C2B_ASK_COMEOUT_WROOM {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_C2B_ASK_COMEOUT_WROOM, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_ANS_COMEOUT_WROOM, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_SEE_COMEOUT_WROOM, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_C2B_ASK_EXIT_MEMBER, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_ANS_EXIT_MEMBER, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_SEE_EXIT_MEMBER, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_WROOM_DATA, 0x62);

// class MSG_B2C_GOTO_LOBBY; size: 0xC
struct MSG_B2C_GOTO_LOBBY {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_B2C_GOTO_LOBBY, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_ASK_END_BATTLE, 0x11);

// class MSG_C2B_ANS_END_BATTLE; size: 0xC
struct MSG_C2B_ANS_END_BATTLE {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_C2B_ANS_END_BATTLE, 0xC);

// class MSG_B2C_SVR_BATTLE_TIME; size: 0xC
struct MSG_B2C_SVR_BATTLE_TIME {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_B2C_SVR_BATTLE_TIME, 0xC);

// class MSG_C2B_ASK_CHANGE_WATCHER; size: 0xC
struct MSG_C2B_ASK_CHANGE_WATCHER {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_C2B_ASK_CHANGE_WATCHER, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_ANS_CHANGE_WATCHER, 0xD);

// class MSG_C2B_ASK_COMEOUT_BFIELD; size: 0xC
struct MSG_C2B_ASK_COMEOUT_BFIELD {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_C2B_ASK_COMEOUT_BFIELD, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_ANS_COMEOUT_BFIELD, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_B2C_SEE_HP_CHANGE, 0x16);
...
TM_STATIC_ASSERT_SIZE(MSG_B2M_TM_RESULT, 0x2E);
...
TM_STATIC_ASSERT_SIZE(MSG_B2M_ASK_PREWEEK_MASTERS, 0x6);
...
TM_STATIC_ASSERT_SIZE(MSG_M2B_ANS_PREWEEK_MASTERS, 0x2B);
...
TM_STATIC_ASSERT_SIZE(MSG_B2M_ASK_TMMSG_BROADCAST, 0x17);
...
TM_STATIC_ASSERT_SIZE(MSG_S2C_FORTIFIER, 0x11);
...
TM_STATIC_ASSERT_SIZE(CShareObject, 0x8);
...
TM_STATIC_ASSERT_SIZE(CSyncSection, 0x1C);
...
TM_STATIC_ASSERT_SIZE(CLinkedList, 0x8);
...
TM_STATIC_ASSERT_SIZE(__ListNODE_, 0xC);
...
TM_STATIC_ASSERT_SIZE(_ITEM_LEVEL_, 0x10);
...
TM_STATIC_ASSERT_SIZE(_ITEM_TABLE0_DATA, 0xD0);
...
TM_STATIC_ASSERT_SIZE(_ITEM_TABLE1_DATA_, 0x2C);
...
TM_STATIC_ASSERT_SIZE(_ITEM_TABLE2_DATA_, 0x28);
...
TM_STATIC_ASSERT_SIZE(_ITEM_TABLE3_DATA_, 0x28);
...
TM_STATIC_ASSERT_SIZE(_ITEM_COUNTER, 0x8);
...
TM_STATIC_ASSERT_SIZE(_ITEM_COMBINATION_TABLE_, 0x20);
...
TM_STATIC_ASSERT_SIZE(CItemManage, 0x87E04);

// class CSkill; size: 0xC
struct CSkill {
    /* 0x0000 */ int32_t m_Skills[3];
};
TM_STATIC_ASSERT_SIZE(CSkill, 0xC);

// struct _OBJECT_; size: 0x1
struct _OBJECT_ {
    /* 0x0000 */ uint8_t objType;
};
TM_STATIC_ASSERT_SIZE(_OBJECT_, 0x1);
...
TM_STATIC_ASSERT_SIZE(CSimpleSyncSection, 0x8);
...
TM_STATIC_ASSERT_SIZE(CPC__CPCStatChange, 0x14);

// struct _LASTINGSKILL_MANAGEARRARY_; size: 0x30
struct _LASTINGSKILL_MANAGEARRARY_ {
    /* 0x0000 */ _LASTINGSKILL_INFO_ LastingSkillInfo[4];
};
TM_STATIC_ASSERT_SIZE(_LASTINGSKILL_MANAGEARRARY_, 0x30);
...
TM_STATIC_ASSERT_SIZE(CCheckHACK, 0x24);
...
TM_STATIC_ASSERT_SIZE(CPC___REMEMBER_ENEMY_, 0x18);
...
TM_STATIC_ASSERT_SIZE(CPC__PCINFO4BATTLE, 0x20);
...
TM_STATIC_ASSERT_SIZE(CPC, 0x3EC);

// class CNPC; size: 0x0
struct CNPC {
    /* zero-sized UDT in PDB; C++ materializes this as size 1. */
};
/* TM_STATIC_ASSERT_SIZE(CNPC, 0x0) omitted for zero-sized PDB type. */
...
TM_STATIC_ASSERT_SIZE(CPCManage, 0x3070);
...
TM_STATIC_ASSERT_SIZE(CClan___CLANMEMBER_, 0x14);
...
TM_STATIC_ASSERT_SIZE(CClan, 0x154);
...
TM_STATIC_ASSERT_SIZE(_CLAN_MSG_, 0x28);
...
TM_STATIC_ASSERT_SIZE(_CLAN_MS_MSG_, 0x18);
...
TM_STATIC_ASSERT_SIZE(CClanManage, 0x24);
...
TM_STATIC_ASSERT_SIZE(_MATCH_INFO_, 0x14);
...
TM_STATIC_ASSERT_SIZE(CTMNode, 0x18);
...
TM_STATIC_ASSERT_SIZE(CTMTree, 0x94);
...
TM_STATIC_ASSERT_SIZE(_CELL_, 0x4);
...
TM_STATIC_ASSERT_SIZE(_DROP_ITEM_, 0xC);
...
TM_STATIC_ASSERT_SIZE(CCell, 0x24);
...
TM_STATIC_ASSERT_SIZE(CTeam, 0x18);
...
TM_STATIC_ASSERT_SIZE(_WARP_, 0x8);

// struct _START_POS_; size: 0x10
struct _START_POS_ {
    /* 0x0000 */ unsigned long cellIndex[4];
};
TM_STATIC_ASSERT_SIZE(_START_POS_, 0x10);
...
TM_STATIC_ASSERT_SIZE(CRoom__CMM_OPT, 0x8);
...
TM_STATIC_ASSERT_SIZE(CRoom__NRM_OPT, 0x8);
...
TM_STATIC_ASSERT_SIZE(CRoom, 0x24019C);
...
TM_STATIC_ASSERT_SIZE(CMapFile, 0x240098);
...
TM_STATIC_ASSERT_SIZE(CRoomManage, 0x38);
...
TM_STATIC_ASSERT_SIZE(CGameLog, 0x84);

// class CTimeFunc; size: 0x1
struct CTimeFunc {
    uint8_t _pad_tail[0x1];
};
TM_STATIC_ASSERT_SIZE(CTimeFunc, 0x1);
...
TM_STATIC_ASSERT_SIZE(_PET_TABLE_DATA_, 0x28);
...
TM_STATIC_ASSERT_SIZE(CPetManage, 0x410C);
...
TM_STATIC_ASSERT_SIZE(CUDPSock, 0x40C);
...
TM_STATIC_ASSERT_SIZE(CSimpleCrypt, 0x10);

// class MSG_HEADER; size: 0x2
struct MSG_HEADER {
    /* 0x0000 */ uint16_t wProtocol;
};
TM_STATIC_ASSERT_SIZE(MSG_HEADER, 0x2);
...
TM_STATIC_ASSERT_SIZE(MSG_S2V_WARNNING, 0x82);
...
TM_STATIC_ASSERT_SIZE(_TMRESULT_, 0x28);
...
TM_STATIC_ASSERT_SIZE(CAStar, 0x220);
...
TM_STATIC_ASSERT_SIZE(CAStar____NODE, 0x3C);
...
TM_STATIC_ASSERT_SIZE(CAStar____STACK, 0x8);
...
TM_STATIC_ASSERT_SIZE(_WARP_WAIT_PC_, 0xC);
...
TM_STATIC_ASSERT_SIZE(_LOG_DATA_, 0x804);
...
TM_STATIC_ASSERT_SIZE(CLoopSleepMgr, 0x14);
...
TM_STATIC_ASSERT_SIZE(CMainServer, 0x80007C);
...
TM_STATIC_ASSERT_SIZE(CTickManage, 0x38);
...
TM_STATIC_ASSERT_SIZE(CMsgCrypt, 0x14);
...
TM_STATIC_ASSERT_SIZE(CLargeRand, 0x9D0);
...
TM_STATIC_ASSERT_SIZE(CListenServer, 0x48);
...
TM_STATIC_ASSERT_SIZE(CSystemMgr, 0x420);
...
TM_STATIC_ASSERT_SIZE(CSvrManage, 0x38);

// class CLobby; size: 0xC
struct CLobby {
    /* 0x0000 */ uint8_t m_PCList[0xC]; /* original type: std::list<CPC *,std::allocator<CPC *> > */
};
TM_STATIC_ASSERT_SIZE(CLobby, 0xC);
...
TM_STATIC_ASSERT_SIZE(CTMManage, 0x6AC);
...
TM_STATIC_ASSERT_SIZE(_SKILL_DATA_TABLE_, 0x5E);
...
TM_STATIC_ASSERT_SIZE(_PC_DATA_TABLE_, 0x1C);
...
TM_STATIC_ASSERT_SIZE(CGateServer, 0x80009C);
...
TM_STATIC_ASSERT_SIZE(CStandbyServer, 0x800080);
...
TM_STATIC_ASSERT_SIZE(MSG_G2S_DISCONNECT, 0xB);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_ASK_MOVE, 0x11);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_PC_MOVE, 0x11);

// class MSG_C2S_CHAR_LOGOUT; size: 0xC
struct MSG_C2S_CHAR_LOGOUT {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_C2S_CHAR_LOGOUT, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_ASK_ATTACK, 0x12);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_ASK_SKILL, 0x12);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_USE_POTION, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_PICKUP_ITEM, 0x18);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_DROP_ITEM, 0x15);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_SELL_ITEM, 0x20);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_GIVE_ITEM, 0x18);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_ASK_DEAL, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_ANS_DEAL, 0x11);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_PUTIN_ITEM, 0x1C);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_PUTOUT_ITEM, 0x1C);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_DECIDE_DEAL, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_CONFIRM_DEAL, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_ALLOT_POINT, 0x11);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_PUTIN_PET, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_PUTOUT_PET, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_MOVE_ITEM, 0x16);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_WEAR_ITEM, 0x14);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_STRIP_ITEM, 0x14);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_REVIVE_PET, 0x14);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_BUY_ITEM, 0x14);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_ASK_HEAL, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_RETURN2HERE, 0x12);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_ACTIVE_PET, 0x10);

// class MSG_C2S_INACTIVE_PET; size: 0xC
struct MSG_C2S_INACTIVE_PET {
    /* 0x0000 */ MSG_S2C_HEADER MsgHeader;
};
TM_STATIC_ASSERT_SIZE(MSG_C2S_INACTIVE_PET, 0xC);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_GESTURE, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_OPTION, 0xD);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_SUBMAP_INFO, 0x10);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_ENTER, 0x50);
...
TM_STATIC_ASSERT_SIZE(MSG_M2S_ERROR, 0x49);
...
TM_STATIC_ASSERT_SIZE(MSG_C2S_LEARN_SKILL, 0x15);
...
TM_STATIC_ASSERT_SIZE(MSG_G2S_SVR_LOGIN, 0xB);

#pragma pack(pop)

#undef TM_STATIC_ASSERT_SIZE

#endif /* TMSERVER_RECOVERED_H */
